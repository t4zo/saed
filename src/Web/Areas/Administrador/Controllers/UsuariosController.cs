...
namespace SAED.Web.Areas.Administrador.Controllers
{
    ...
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            var userPermissions = _context.UserClaims.Where(x => x.UserId == user.Id).Select(x => x.ClaimValue);
            ...
            return View(new UsuarioViewModel { Usuario = user, RolesEscolhidas = roles, PermissoesEscolhidas = permissions });
        }
